...
(start_bhid.bat & stop_bhid.bat), backend process startup, and graceful shutdown orchestration.
"""
...
:: 2. Pre-flight Environment & Release Verification Check
echo [STEP 1/3] Running Pre-flight Release Verification & Environment Check...
...
echo [OK] Environment & Release Verification Passed.
echo.
...
:: 4. Launch BHID Backend Runtime Service in a Dedicated Terminal
echo [STEP 3/3] Starting BHID Backend Service in a Dedicated Command Window...
...
"""
    ...
    def start_backend(self) -> Dict[str, Any]:
        """
        Executes backend startup sequence, creates PID file under `bhid/data/runtime/bhid.pid`,
        and launches initialization orchestrator.
        """
        ...
        print("\n====================================================================")
        print("  BHID Operational Backend Service Active")
        print(f"  - PID: {pid} (Saved to {pid_file})")
        print(f"  - Active Scene: {self.orchestrator.get_context().active_scene}")
        print("  - Press Ctrl+C or run stop_bhid.bat to terminate.")
        print("====================================================================\n")
